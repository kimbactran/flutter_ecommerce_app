...
class EcoCloudHelperFunctions {
  ...
  // If no data found, it returns a generic 'No Data Found" message.
  ...
  // If data is still loading, it returns a CircularProgressIndicator.
  // If no data is found, it returns a generic "No Data Found" message or custom nothingFoundWidget if provided.
  // If an error occurs, it returns a generic error message.
  // Otherwise, it returns null.
