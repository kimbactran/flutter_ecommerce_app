class EcoFirebaseException implements Exception {
  final String code;

  EcoFirebaseException(this.code);
  ...
  String get message {
    switch (code) {
      ...
      case 'app-not-authorized':
        return 'The app is not authorized to user Firebase Authentication with the provided API key.';
      case 'keychain-error':
        return 'A keychain error occurred. Please check the keychain and try again.';
      case 'internal-error':
        return 'An internal authentication error occurred. Please try again later.';
      case 'invalid-app-credential':
        return 'The app credential is invalid. Please try again later.';
      case 'user-mismatch':
      ...
      case 'web-storage-unsupported':
        return 'Web storage is not supported or is disable.';
      case 'app-deleted':
